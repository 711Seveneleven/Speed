...
//
///**
// * @ClassName WarmLaunchSpeed
// * @Description TODO
// * @Author: wangliao 80260910
// * @Date: 2020/2/14 14:46
// */
//public class WarmLaunchSpeed  extends TopoAndroid {
//
//    @Override
...
//
//        // 定义工程路径，用于获取依赖的工具
//        String mtnPath = "E:\\LocalPerfTestTool_1.5.1_20200213";
//        LaunchSpeed.setMtnPath(mtnPath);
//
//        // 方案一：通过 手动监控的已有训练集 获取启动速度
//        String trainDataHome = "E:\\LocalPerfTestTool_1.5.1_20200213\\home\\task\\debug\\log\\9950\\report";
//        String startStage = "0";
//        String endStage = "3";
//        // 设置视频分析模式 1：训练集模式 2：图片标记模式
...
//
//        // 方案二：通过 用户提供的标志图片 获取启动速度
//        // 设置视频分析模式 1：训练集模式 2：图片标记模式
////        LaunchSpeed.setAnalyzeType(2);
////        String startFolder = "E:\\my_workspace\\Python\\tm-git\\timemachine-project\\cases\\mytest\\start_pic";
////        String endFolder = "E:\\my_workspace\\Python\\tm-git\\timemachine-project\\cases\\mytest\\end_pic";
////        // 设置开始标记文件夹
////        LaunchSpeed.setStartFolder(startFolder);
////        // 设置结束标记文件夹
////        LaunchSpeed.setEndFolder(endFolder);
//
...
////        Common.executeAdbShellCommand(phone, "am start com.oapm.sample/com.oapm.sample.MainActivity");
//
//        // 进行5次测试
//        for (int i=0; i<5; i++) {
...
//            // 启动软件，这里采用phenix已有接口，也可以自定义启动方式，如点击icon
//            boolean warmStartApp = Common.startApplication(phone, pkgName);
//            if (!warmStartApp) return false;
////            Common.executeAdbShellCommand(phone, "am start com.oapm.sample/com.oapm.sample.MainActivity");
