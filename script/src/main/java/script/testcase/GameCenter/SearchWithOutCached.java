...
public class SearchWithOutCached extends TopoAndroid {
    Phone phone;
    String pkgName;
    ...
    protected boolean test() throws Exception {
        ...
        for (int i=0; i<10; i++) {
            ...
            PhenixLog.info("--------等待2s------");
            Widget.clickByText(phone,"我的",ClickType.NORMAL);
            Common.wait(phone,2);
            Widget.clickById(phone,"com.nearme.gamecenter:id/my_setting",ClickType.NORMAL);
            Common.wait(phone,2);
            Widget.clickByText(phone,"清理缓存",ClickType.NORMAL);
            Common.wait(phone,3);
            Common.goBack(phone);
            Common.wait(phone,2);
    ...
    public static void main(String[] args) {
        new SearchWithOutCached().run(args);
    }
}
