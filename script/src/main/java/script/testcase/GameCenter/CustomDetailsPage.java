...
public class CustomDetailsPage extends TopoAndroid {
    ...
    protected boolean test() throws Exception {
        ...
        Common.wait(phone,2);
        Widget.inputTextById(phone,"com.nearme.gamecenter:id/et_search","敢达决战");
        Common.wait(phone,2);
        ...
        String modelFile="E:\\MTN\\tools\\timemachine-project\\videos\\CustomDetailsPage.h5";
        String startStage = "0";
        String endStage = "3";
        //设置相邻图片相似度为0.999,默认0.98不用设置
        ...
        for (int i=0; i<10;i++) {
            ...
            // 等待进入稳定阶段（根据每个APP到达稳定的时间决定是否需要等待），等待3s
            Common.wait(phone,3);
    ...
    public static void main(String[] args) {
        new CustomDetailsPage().run(args);
    }
}
